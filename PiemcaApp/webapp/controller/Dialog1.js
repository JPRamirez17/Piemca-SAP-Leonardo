sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.piemca.controller.Dialog1", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.piemca.view.Dialog1", this);
			this._bInit = false;
		},
