sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.piemca.controller.MasterProduct", {
			...
			if (status) {
				...
				return new Promise(function(fnResolve, fnReject) {
					...
					if (bHasPendingChanges) {
						...
						var oNewEntityInstance = Utilities.getDefaultValuesForDetailProductEdit();
						...
						this.doNavigate("DetailProductEdit", oNewBindingContext, fnResolve);
					}
				}.bind(this)).catch(function(err) {
					if (err !== undefined) {
						MessageBox.error(err.message);
		...
		_onObjectListItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("DetailProduct", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		_onSearchFieldLiveChange: function(oEvent) {
			var sControlId = "sap_List_Page_0-content-sap_m_ObjectList-1-hxkzng72ueq2cw909avy9yu015_S15";
			...
			return new Promise(function(fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					...
					aFilters.push(new sap.ui.model.Filter("Category", sap.ui.model.FilterOperator.Contains, sQuery));
					...
					if (!isNaN(iQuery)) {
						aFilters.push(new sap.ui.model.Filter("Stock", sap.ui.model.FilterOperator.EQ, sQuery));
					}

					aFilters.push(new sap.ui.model.Filter("Supplies", sap.ui.model.FilterOperator.Contains, sQuery));
		...
		onInit: function() {
			...
			this.oRouter.getTarget("MasterProduct").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_List_Page_0-content-sap_m_ObjectList-1-hxkzng72ueq2cw909avy9yu015_S15",
				"groups": ["items"]
			}];
