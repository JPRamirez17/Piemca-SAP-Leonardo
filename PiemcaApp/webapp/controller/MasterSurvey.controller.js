sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.piemca.controller.MasterSurvey", {
			...
			if (status) {
				...
				return new Promise(function(fnResolve, fnReject) {
					...
					if (bHasPendingChanges) {
						...
						var oNewEntityInstance = Utilities.getDefaultValuesForDetailSurveyCreate();
						oNewEntityInstance["___FK_fd103d42ea13adbc183d5c08_00033"] = oSourceBindingContext.getProperty("ID");

						oModel = this.getView().getModel();
						var oNewBindingContext = oModel.createEntry("SurveySet", {
							properties: oNewEntityInstance
						});

						this.doNavigate("DetailSurveyCreate", oNewBindingContext, fnResolve);
					}
				}.bind(this)).catch(function(err) {
					if (err !== undefined) {
						MessageBox.error(err.message);
		...
		_onObjectListItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("DetailSurvey", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		_onSearchFieldLiveChange: function(oEvent) {
			var sControlId = "sap_List_Page_0-content-sap_m_ObjectList-1-poqilvzj25kr68rzxzxvnq5b3_S3-f58m18lgtmb3l1r8umw6klrx7_S7";
			...
			return new Promise(function(fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					...
					aFilters.push(new sap.ui.model.Filter("ClientName", sap.ui.model.FilterOperator.Contains, sQuery));
		...
		onInit: function() {
			...
			this.oRouter.getTarget("MasterSurvey").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_List_Page_0-content-sap_m_ObjectList-1-poqilvzj25kr68rzxzxvnq5b3_S3-f58m18lgtmb3l1r8umw6klrx7_S7",
				"groups": ["items"]
			}];
